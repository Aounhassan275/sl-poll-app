...
class ManualEnterView5 extends StatefulWidget {
  const ManualEnterView5({super.key});

  @override
  State<ManualEnterView5> createState() => _ManualEnterView5State();
}

class _ManualEnterView5State extends State<ManualEnterView5> {
  @override
