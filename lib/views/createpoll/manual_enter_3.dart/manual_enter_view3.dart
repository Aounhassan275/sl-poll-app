...
class ManualEnterView3 extends StatefulWidget {
  const ManualEnterView3({super.key});

  @override
  State<ManualEnterView3> createState() => _ManualEnterView3State();
}

class _ManualEnterView3State extends State<ManualEnterView3> {
  @override
