...
class ManualEnterView2 extends StatefulWidget {
  @override
  _ManualEnterView2State createState() => _ManualEnterView2State();
}

class _ManualEnterView2State extends State<ManualEnterView2> {
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PollEntityQuestionView()),
                        );
                      },
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            TextSpan(
                                                                                text: 'Filters for Oil',
                                                                                style: TextStyle(color: blue, fontSize: 20, fontFamily: 'Roboto', fontWeight: FontWeight.w600)),
                                                                            TextSpan(
                                                                                text: '\nenable the substitution for \n',
                                                                                style: TextStyle(color: maincolor, fontSize: 20, fontFamily: 'Roboto', fontWeight: FontWeight.w600)),
                                                                            TextSpan(
                                                                                text: 'Dirty Oil',
                                                                                style: TextStyle(color: pinkColor, fontSize: 20, fontFamily: 'Roboto', fontWeight: FontWeight.w600)),
                                                                            TextSpan(
                                                                                text: ' ?',
                                                                                style: TextStyle(color: maincolor, fontSize: 20, fontFamily: 'Roboto', fontWeight: FontWeight.w600)),
                                                                          ],
