...
class ManualEnterView7 extends StatefulWidget {
  const ManualEnterView7({super.key});

  @override
  State<ManualEnterView7> createState() => _ManualEnterView7State();
}

class _ManualEnterView7State extends State<ManualEnterView7> {
  @override
